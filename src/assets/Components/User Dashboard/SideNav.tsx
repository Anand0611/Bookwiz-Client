...
const SideNav = ({ activeItemFromMain }: { activeItemFromMain: string }) => {
  ...
  return (
    <nav className="bg-gray-800 text-white px-4 py-5 w-64 md:block hidden h-screen">
      <span className="text-2xl font-bold bg-gray-800 font-['Montserrat'] uppercase pt-[10px] pb-[39px] shadow-xl border-b-2 border-gray-600 text-white flex items-center justify-center mb-5 ">
        SNGIST Library
      </span>
      <ul className="space-y-4">
        ...
        <li className="group">
          ...
          >
            <AiOutlineUser
              className={`text-xl mr-2 text-gray-600 group-hover:text-white ${
                activeItem === "Profile" ? "text-green-100" : ""
              }`}
            />
            <span className="transition duration-300 ease-in-out group-hover:text-white font-['Montserrat'] text-[18px]">
              Edit Profile
        ...
        <li className="group">
          ...
          >
            <AiOutlineBook className="text-xl mr-2 text-gray-600 group-hover:text-white" />
            <span className="transition duration-300 ease-in-out group-hover:text-white font-['Montserrat'] text-[18px]">
              Borrow Book
            </span>
          </a>
        ...
        <li className="group">
          <a
            ...
            className="flex items-center p-4 hover:bg-gray-700 cursor-pointer transition duration-300 ease-in-out"
          >
            <AiOutlineSearch className="text-xl mr-2 text-gray-600 group-hover:text-white" />
            <span className="transition duration-300 ease-in-out group-hover:text-white font-['Montserrat'] text-[18px]">
              Search
            </span>
          </a>
        ...
        <li className="group">
          <a
            ...
            className="flex items-center p-4 hover:bg-gray-700 cursor-pointer transition duration-300 ease-in-out"
          >
            <AiOutlineLogout className="text-xl mr-2 text-gray-600 group-hover:text-white" />
            <span className="transition duration-300 ease-in-out group-hover:text-white font-['Montserrat'] text-[18px]">
              Logout
            </span>
          </a>
